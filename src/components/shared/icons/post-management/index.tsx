...
export default function PostManagementLogo(props: Props) {
    ...
    return (
        <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <path d="M7 17H11" stroke={props.stroke} fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}
